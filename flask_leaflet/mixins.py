...
class RenderOptions(ABC):
    ...
    def __render_list_str(self, data_list: list[t.Any] | tuple[t.Any], as_variable: bool = False) -> str:
    ...
    def __render_dict_str(self, data_dict: dict[str, t.Any], as_variable: bool = False) -> str:
